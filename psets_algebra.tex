...
よって, (1) より, $\sigma (S) \subset S$ となるから, (N3) より $S = \bm{N}$ となる. これは, $\forall n \in \bm{N},\ \sigma (n) \neq n$ を意味する.\footnote[1]{$P(0)$が真かつ$P(n)$が真ならば$P(\sigma (n))$ が真であれば $S = \{ n\in \bm{N}\ |\ P(n)\}$ とすることで N3 を使える.\vspace{30pt}}
...
以上より, 任意の $n \in \bm{N}\backslash \{0\}$ に対して, $\exists m\in \bm{N},\ \sigma (m) = n$ となる. ちなみに, (N2) とから, $\bm{N}\backslash \{0\} = \sigma (\bm{N})$ が成り立つ. 
} 
\end{nmprob}
